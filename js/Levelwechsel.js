...
MainGame.Levelwechsel.prototype = {
    ...
    create: function() {
        ...
        //Add the game title so we know the state is properly working
            ...
            this.pauseBanner = game.add.image(game.world.centerX + 20, game.world.centerY - 70, 'pause');
